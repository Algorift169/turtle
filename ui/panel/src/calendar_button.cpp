#include "../include/calendar_button.hpp"
...
CalendarButton::CalendarButton() : icon_path_("images/icons/calender.svg") {}

void CalendarButton::draw(Display* display, Window window, int x, int y, int width, int height, int icon_size, bool hover) const {
