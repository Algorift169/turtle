#include "../include/browser_button.hpp"
...
BrowserButton::BrowserButton() : icon_path_("images/icons/browser.png") {}

void BrowserButton::draw(Display* display, Window window, int x, int y, int width, int height, int icon_size, bool hover) const {
