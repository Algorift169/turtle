#include "../include/shutdown_button.hpp"
...
ShutdownButton::ShutdownButton() : icon_path_("images/icons/shut-down.svg") {}

void ShutdownButton::draw(Display* display, Window window, int x, int y, int width, int height, int icon_size, bool hover) const {
