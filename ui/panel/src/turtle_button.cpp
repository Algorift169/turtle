#include "../include/turtle_button.hpp"
...
TurtleButton::TurtleButton() : icon_path_("images/icons/turtle.svg") {}

void TurtleButton::draw(Display* display, Window window, int x, int y, int width, int height, int icon_size, bool hover) const {
    ...
    draw_icon(display, window, icon_path_, x + 2, y + 2, icon_size + 2);
    XFreeGC(display, gc);
}
